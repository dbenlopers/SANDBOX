...
Latest image is always the most recent version of Apache Spark available. 

### Apache Spark latest [i.e. v2.3]
[Dockerfile for Apache Spark v2.3](https://github.com/ArnaudKOPP/Spark_docker)
...
Copy the [`Dockerfile`](Dockerfile) to a folder on your local machine and then invoke the following command.
    ...
    docker build -t ArnaudKOPP/Spark_docker .

### Pull the latest image

    docker pull ArnaudKOPP/Spark_docker


## Run Spark image
### Run the image

    docker run -it -p 4040:4040 -p 8080:8080 -p 8081:8081 -h spark --name=spark ArnaudKOPP/Spark_docker
...
Copyright &copy; 2018 Arnaud KOPP.<br>
