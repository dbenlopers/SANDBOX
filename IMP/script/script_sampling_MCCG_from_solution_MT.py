'''
Create models from solution with multithreading
...
#sample_indexes      = range(120,130) #10 attempts MCCGsampler
...
#    mcs     = HGM.representation.MyConfigurationSet(tfiihInfos)
    ...
    sol_file_path="/home/arnaud/dev/TFIIH/data/ARP/save-1TYQ-HGM.txt"
