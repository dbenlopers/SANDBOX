...
#sample_indexes      = range(10,20) #10 attempts MCCGsampler
...
def refine_sample_mccg(tfiihInfos,mcs):
    ...
    particles       = tfiihInfos.get_all_particles()
...
#    pool = Pool(processes = int(20))    
#    
#    try:
#        [pool.apply_async(main,(i)) for i in range(100)]    
#        pool.close()
#        pool.join()
#        
...
#        pool.terminate()
    ...
    for i in range(0,5):
        p = Process(target=main,args=(i,R()))
        p.start()
            
            
    #ou comme cela
    
#    p1 = Process(target=main,args=(1,R()))
#    p1.start()
#    p2 = Process(target=main,args=(2,R()))
#    p2.start()
#    p3 = Process(target=main,args=(3,R()))
#    p3.start()
#    p4 = Process(target=main,args=(4,R()))
#    p4.start()
#    p5 = Process(target=main,args=(5,R()))
#    p5.start()
#    p6 = Process(target=main,args=(25,R()))
#    p6.start()
#    p7 = Process(target=main,args=(26,R()))
#    p7.start()
#    p8 = Process(target=main,args=(27,R()))
#    p8.start()
#    p9 = Process(target=main,args=(28,R()))
#    p9.start()
#    p10 = Process(target=main,args=(29,R()))
#    p10.start()
