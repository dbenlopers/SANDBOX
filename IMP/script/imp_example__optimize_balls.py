...
#mc=IMP.core.MonteCarloWithLocalOptimization(cg,10)
...
for i in range(1,nb_opti_loops+1):
    ...
    x6=IMP.core.XYZR_decorate_particle(movers[6].get_output_particles()[0])
    print "MOVER6 : ",x6.get_name(),":",x6.get_radius() 
