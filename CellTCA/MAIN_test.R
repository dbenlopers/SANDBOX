...
## import arg
csvDir = "/home/arnaud/Desktop/Ali/clean/" # PARAM HERE !!!!!!!!!!!!
outputdir = "/home/arnaud/Desktop/Ali/clean/170215full/" # PARAM HERE !!!!!!!!!!!!
...
tox = as.character("C4")
Threshold.ref =20
colAnalyze <- c("TotalIntenCh2") # PARAM HERE !!!!!!!!!!!!
median.processing <- F
nb.process <- 3
SVM.processing <- FALSE ## bug don't use it yet
